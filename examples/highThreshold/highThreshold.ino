...
void setup() 
{
   ...
   */
  bmm150.setPresetMode(BMM150_PRESETMODE_ENHANCED);
   ...
   */
  bmm150.setHighThresholdInterrupt(HIGH_INTERRUPT_X_ENABLE ,HIGH_INTERRUPT_Y_ENABLE ,HIGH_INTERRUPT_Z_ENABLE ,0);
}

void loop() 
{
  struct bmm150MagData magData;
  uint8_t interruptState = bmm150.getHighThresholdInterrputState();
