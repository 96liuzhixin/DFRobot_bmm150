...
#define POKARITY_HIGH                    1
#define POKARITY_LOW                     0

#define ENABLE_DRDY                      1
#define DISABLE_DRDY                     0
...
#define LOW_INTERRUPT_X_ENABLE           0
#define LOW_INTERRUPT_Y_ENABLE           0
#define LOW_INTERRUPT_Z_ENABLE           0
#define LOW_INTERRUPT_X_DISABLE          1
#define LOW_INTERRUPT_Y_DISABLE          1
#define LOW_INTERRUPT_Z_DISABLE          1
#define HIGH_INTERRUPT_X_ENABLE          0
#define HIGH_INTERRUPT_Y_ENABLE          0
#define HIGH_INTERRUPT_Z_ENABLE          0
#define HIGH_INTERRUPT_X_DISABLE         1
#define HIGH_INTERRUPT_Y_DISABLE         1
#define HIGH_INTERRUPT_Z_DISABLE         1
#define CHANNEL_X                        1
#define CHANNEL_Y                        2
#define CHANNEL_Z                        3
 ...
 */
struct bmm150Settings
{
    /*! Control measurement of XYZ axes */
    uint8_t xyzAxesControl;
