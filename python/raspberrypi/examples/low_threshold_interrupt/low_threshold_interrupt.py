# -*- coding:utf-8 -*-
"""
  @file low_threshold_interrupt.py
...
def setup():
  ...
  '''
  bmm150.set_low_threshold_interrupt(LOW_INTERRUPT_X_ENABLE ,LOW_INTERRUPT_Y_ENABLE ,LOW_INTERRUPT_Z_ENABLE ,0)

def loop():
  number = bmm150.get_low_threshold_interrupt_state()
  if number == 1:
